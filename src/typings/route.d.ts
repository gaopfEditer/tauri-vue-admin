...
declare namespace AuthRoute {
  ...
  type RouteKey =
    ...
    | 'management_auth'
    | 'management_route'
    | 'management_password-policy'
    | 'recipe'
    | 'recipe_list'
    | 'sampling'
    | 'sampling_list'
    | 'sampling_custom-fields'
    | 'sampling_realtime'
    | 'sensors'
    | 'sensors_particle'
    | 'sensors_biocapt'
    ...
    | 'system_device-poll'
    | 'system-view'
    | 'system-view_constant-page'
    | 'system-view_login'
    | 'system-view_no-permission'
    | 'system-view_not-found'
    | 'system-view_not-found-page'
    | 'system-view_service-error'
    | 'license'
    | 'setup'
    | 'setup_wizard'
    | 'setup_db-init'
    | 'setup_db-restore'
    | 'setup_sampler-calibration'
    | 'about';
